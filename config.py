...
SINGBOX_NODE_AUTO_UPGRADE = config("SINGBOX_NODE_AUTO_UPGRADE", default=False, cast=bool)
SINGBOX_NODE_TARGET_IMAGE = config("SINGBOX_NODE_TARGET_IMAGE", default="")
SINGBOX_SYNC_AGENT_VERSION = config("SINGBOX_SYNC_AGENT_VERSION", default="0.10.0-ls1")
